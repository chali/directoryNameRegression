...
class DirectoryCreationJDeb14Spec extends Specification {
    ...
    def 'add directory and confirm that is present'() {
        ...
        maker.setControl(new File(DirectoryCreationJDeb14Spec.getResource('/control').toURI()).parentFile)
